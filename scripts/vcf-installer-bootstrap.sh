#!/bin/bash
#
# VCF Installer/Cloud Builder bring-up: build the Cloud Builder JSON payload, wait for VCF Installer to be reachable, kick off and poll the SDDC build.
#
jsonFile="${1}"
...
hostSpecs=$(cat /tmp/hostSpecs.json)
